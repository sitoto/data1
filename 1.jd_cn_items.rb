...
class Spider
  ...
  def next_list_page
    ...
    current_page = "http://baike.yangche51.com/catagory/7_#{@next_page}.html"
    current_page = "http://www.amazon.cn/s/ref=sr_pg_1?rh=n%3A1947899051%2Cn%3A%211947900051%2Cn%3A2127789051%2Cn%3A1947901051&page=#{@next_page}&bbn=2127789051&ie=UTF8&qid=1372146899"
  end

end

firstpage = 'http://www.amazon.cn/s/ref=sr_pg_2?rh=n%3A1947899051%2Cn%3A%211947900051%2Cn%3A2127789051%2Cn%3A1947901051&page=1&bbn=2127789051&ie=UTF8&qid=1372146899'
